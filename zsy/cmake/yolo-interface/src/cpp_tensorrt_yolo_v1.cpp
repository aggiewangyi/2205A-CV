...
int main() {
	...
	const char* model_path_engine = "F:/CPP-Project/trt_inference/out/build/x64-debug/yolov8n.engine";
	...
	//std::string engine_file_path = "yolov8n.engine";
	//int type = 1;
    ...
    cv::Mat result_image = result.yolov8_result(image, result_array);
