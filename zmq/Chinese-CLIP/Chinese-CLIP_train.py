...
def parse_args():
    ...
    parser.add_argument(
        "--resume",
        default='C:/Users/quant/Desktop/cs/datapath/pretraind_weights/clip_cn_vit-b-16.pt',
        type=str,
...
if __name__ == "__main__":
    ...
    vision_model_config_file = Path(
        __file__).parent.parent / f"C:/Users/quant/Desktop/cs/Chinese-CLIP-master/cn_clip/clip/model_configs/{args.vision_model.replace('/', '-')}.json"
    print('Loading vision model config from', vision_model_config_file)
    assert os.path.exists(vision_model_config_file)

    text_model_config_file = Path(
        __file__).parent.parent / f"C:/Users/quant/Desktop/cs/Chinese-CLIP-master/cn_clip/clip/model_configs/{args.text_model.replace('/', '-')}.json"
