...
class FunASR:
    def __init__(self) -> None:
        # 定义模型的自定义路径
        model_path = "C:/Users/quant/Desktop/cs/Linly-Talker/ASR/FunASR/speech_seaco_paraformer_large_asr_nat-zh-cn-16k-common-vocab8404-pytorch"
        vad_model_path = "C:/Users/quant/Desktop/cs/Linly-Talker/ASR/FunASR/speech_fsmn_vad_zh-cn-16k-common-pytorch"
        punc_model_path = "C:/Users/quant/Desktop/cs/Linly-Talker/ASR/FunASR/punc_ct-transformer_zh-cn-common-vocab272727-pytorch"
...
if __name__ == "__main__":
    ...
    # audio_file = "vo_ABDLQ001_1_paimon_02.wav"  # 音频文件路径
    audio_file = "output.wav"  # 音频文件路径
