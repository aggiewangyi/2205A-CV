...
def parse_args():
    ...
    parser.add_argument(
        '--image-data', 
        type=str, 
        default=r"C:\Users\26296\Desktop\Chinese-CLIP-master\DATAPATH\datasets\MUGE\lmdb\test\imgs",
        help="If --extract-image-feats is True, specify the path of the LMDB directory storing input image base64 strings."
    )
    parser.add_argument(
        '--text-data', 
        type=str, 
        default=r"C:\Users\26296\Desktop\Chinese-CLIP-master\DATAPATH\datasets\MUGE\test_texts.jsonl",
    ...
    parser.add_argument(
        "--resume",
        default=r"C:\Users\26296\Desktop\Chinese-CLIP-master\DATAPATH\pretrained_weights\clip_cn_vit-b-16.pt",
        type=str,
