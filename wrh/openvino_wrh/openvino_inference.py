...
class OpenVino:
    def __init__ (self, model_path, confidence_thres=0.25, iou_thres=0.5):
        ...
        model_xml = os.path.join(model_path,"yolov5s.xml")
        model_bin = os.path.join(model_path,"yolov5s.bin")
        # model_bin = os.path.join(model_path, "yolov516.bin")
        # 加载模型
    ...
    def yaml_load(self, file="data.yaml", append_filename=False):
        ...
        with open(file, errors="ignore", encoding="utf-8") as f:
            ...
            #     s = re.sub(r"[\x09x0A\x0D\x20-\x7E\x85\xA0-\uD7FF\uE000-\uFFFD\U00010000-\U0010ffff]+", "", s)
...
if __name__ =='__main__':
    ...
    model_path = r"D:\Desktop\openvino"

    # model_path = "fish_best_int8_openvino model"
    openvino = OpenVino(model_path)

    image_dir = r"D:\Desktop\openvino\coco\images\train"
